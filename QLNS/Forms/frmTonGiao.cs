...
namespace QLNS
{
    public partial class frmTonGiao : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                var id = Convert.ToInt32(gridView1.GetFocusedRowCellValue("IdTonGiao"));
                _busTonGiao.Delete(id);
                LoadDataGrid();
            }
        }
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (_FormStatus == FormStatus.Create)
            {
                var obj = new TONGIAO
                {
                    TenTonGiao = CommonHandler.ConvertToNullableString(edTenTonGiao.EditValue),
                };

                _busTonGiao.Post(obj);
            }
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            edTenTonGiao.EditValue = grid.GetFocusedRowCellValue("TenTonGiao").ToString();
        }
        #endregion
        ...
        private void ConfigEditControl()
        {
            if (_FormStatus == FormStatus.View)
            {
                edTenTonGiao.ReadOnly = true;
            }
            else if (_FormStatus == FormStatus.Create || _FormStatus == FormStatus.Edit)
            {
                edTenTonGiao.ReadOnly = false;
            }
        }

        private void ClearEditControll()
        {
            edTenTonGiao.EditValue = null;
        }
        #endregion
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            MessageBox.Show("File đã lưu ở C:\\Reports\\MyReport_TonGiao.pdf ");
        }
    }
}