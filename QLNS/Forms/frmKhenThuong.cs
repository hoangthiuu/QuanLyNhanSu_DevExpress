    ...
    public partial class frmKhenThuong : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (_FormStatus == FormStatus.Create)
            {
                ...
                {
                    SoKhenThuongKyLuat = CommonHandler.ConvertToNullableString(edSoKhenThuong.EditValue),
                    ...
                    LoaiKhenThuongKyLuat = "Khen thưởng"
                };
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            edSoKhenThuong.EditValue = CommonHandler.ConvertToNullableString(grid.GetFocusedRowCellValue("SoKhenThuongKyLuat"));
        ...
        {
            var data = _busKhenThuongKyLuat.GetAll().Where(x => x.LoaiKhenThuongKyLuat == "Khen thưởng");
